            ...
            <table id="producto_data" class="table display responsive nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button class="btn btn-danger"><div class="fa fa-trash"></button></td>
                  
                </tr>
                <tr>
                  <td>Agua de 1L</td>
                  <td><button type="button" class="btn btn-outline-primary btn-icon">Editar</button></td>
                  <td><button type="button" class="btn btn-outline-danger btn-icon">Eliminar</button></td>
